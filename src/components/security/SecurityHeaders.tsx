...
const SecurityHeaders = () => {
  useEffect(() => {
    ...
    cspMeta.content = [
      ...
      "connect-src 'self' https://api.stripe.com https://*.supabase.co wss://*.supabase.co https://*.lovable.app https://*.tawk.to wss://*.tawk.to",
      "frame-src 'self' https://js.stripe.com https://hooks.stripe.com https://*.lovable.app https://*.tawk.to",
      "object-src 'none'",
      "base-uri 'self'",
      "form-action 'self'",
