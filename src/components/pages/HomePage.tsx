                ...
                <CardContent className="p-4 sm:p-6 md:p-8">
                  <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="bg-slate-800/50 border border-cyan-500/20 rounded-lg p-4 sm:p-6 my-6 sm:my-8">
      ...
      <section className="py-10 sm:py-16 md:py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="bg-gradient-to-br from-slate-800/80 to-slate-700/80 p-4 sm:p-6 md:p-8 rounded-xl border border-green-500/20 hover:border-green-400/50 transition-all duration-300">
              <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-green-500 to-emerald-500 rounded-full flex items-center justify-center mb-4 sm:mb-6">
            ...
            <div className="bg-gradient-to-br from-slate-800/80 to-slate-700/80 p-4 sm:p-6 md:p-8 rounded-xl border border-blue-500/20 hover:border-blue-400/50 transition-all duration-300">
              <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-blue-500 to-indigo-500 rounded-full flex items-center justify-center mb-4 sm:mb-6">
            ...
            <div className="bg-gradient-to-br from-slate-800/80 to-slate-700/80 p-4 sm:p-6 md:p-8 rounded-xl border border-red-500/20 hover:border-red-400/50 transition-all duration-300">
              <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-red-500 to-pink-500 rounded-full flex items-center justify-center mb-4 sm:mb-6">
                <Globe className="h-6 w-6 sm:h-8 sm:w-8 text-white" />
              </div>
